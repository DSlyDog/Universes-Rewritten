...
public class GameModeOverride extends GUIItem {

    public GameModeOverride(boolean currentValue){
        Material[] materials = {Material.GRASS_BLOCK};
        List<String> lore1 = new ArrayList<>();
        lore1.add(Utils.chat("&dClick to enable or disable."));
        lore1.add(Utils.chat("&cGameMode Override is disabled."));
        List<String> lore2 = new ArrayList<>();
        lore2.add(Utils.chat("&dClick to enable or disable."));
        lore2.add(Utils.chat("&2GameMode Override is enabled."));

        super.create(Utils.chat("&bGame Mode Override"), 1, true, currentValue, materials, lore1, lore2);
    }
